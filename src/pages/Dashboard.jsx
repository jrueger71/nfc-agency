...
export default function Dashboard() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      setData({ players:p.data||[], clubInfo:ci.data||[], agencyContracts:ac.data||[], finSummary:fs.data||[], transactions:tx.data||[] })
      setLoading(false)
    })
  }, [])
  ...
  if (loading) return <div style={{ textAlign:'center', padding:60, fontFamily:'Bebas Neue', color:GOLD, letterSpacing:3, fontSize:20 }}>CARGANDO PANEL...</div>
